...
export default function Sidebar() {
    return (
        <div className="hidden sm:flex flex-col p-2 m:items-start fixed h-full">
            ...
            {/* Button  */}
            <button className="btn-blue hidden md:inline my-2.5">Tweet</button>

            {/* Mini-Profile  */}
            <div className="hoverEffect text-grey-700 flex items-center justify-center md:justify-start mt-auto">
                <Image className="rounded-full" width={50} height={50} src="https://tricky-photoshop.com/wp-content/uploads/2017/08/final-1.png" />
                <div className="leading-5 ml-3 hidden md:inline">
